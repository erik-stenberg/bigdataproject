...
### Project Objectives:
1) Utilising big data analytics tools introduced in class to analyse US housing mortgage data. 
2) To Visualise and explore interesting facts from the data set. 
3) Modelling and forecasting relevant variables and evaluate its accuracy.
